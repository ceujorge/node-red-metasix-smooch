...
module.exports = function (RED) {
      ...
      if(contextSend.get(msgstatus))
      {
        ...
        if(usrcontex.onetimenode){
          ...
          if(idx > -1)
          {
            ...
            {
              usrcontex.onetimenode[idx].fristtime = true;
            }
          }
          else
            usrcontex.onetimenode.push({"name":name,"fristtime":true})
  ...
  RED.nodes.registerType("One Send", OneSendNode);
