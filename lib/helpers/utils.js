...
String.prototype.textFromDataForm = function textFromDataForm(contextChange,msg)
  {
      ...
      for (var i=0; i<userContext.questions.length; i++)
        ...
        if(sub)
        {
          ...
          {
            novo = eval("msg."+sub[0]);
            dataReplaceNew = dataReplaceNew.replace("{{msg:"+sub[0]+"}}",novo);
          }
        }
